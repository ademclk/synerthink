                ...
                <div className="absolute inset-0 z-10 flex flex-col items-center justify-center p-4 pointer-events-none">
                    ...
                    <div className="flex flex-col items-center justify-center w-full flex-1 pt-32 sm:pt-0">
                        <div className="flex flex-col items-center gap-10">
                            <div className="pointer-events-auto backdrop-blur-xl bg-foreground/10 rounded-full px-8 sm:px-10 md:px-12 lg:px-12 py-4 sm:py-6 md:py-7 lg:py-8 border border-foreground/10 shadow-2xl max-w-4xl">
                                <h2 className="text-center text-3xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-extrabold tracking-tight text-foreground">
                                    Create What Matters.
                                </h2>
                            ...
                            <Link
                                ...
                                className="group pointer-events-auto inline-flex items-center justify-center bg-primary text-primary-foreground font-bold text-base sm:text-lg rounded-full px-6 py-3 sm:px-8 sm:py-4 shadow-2xl border border-primary-foreground/20 transform-gpu transition-all duration-300 hover:brightness-110 active:scale-95"
                            >
                                See What's Possible
                                <ArrowRight className="ml-2 sm:ml-3 h-5 w-5 sm:h-6 sm:w-6" strokeWidth={2.5} />
                            </Link>
                        </div>
                    </div>
                </div>
